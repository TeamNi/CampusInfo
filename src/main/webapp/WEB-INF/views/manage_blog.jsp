...
<body class="page-header-fixed page-boxed page-full-width">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Blog Management <small>Management Campus Blog</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-edit"></i>Editable Blog Table</div>
							<div class="tools">
							...
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<c:forEach items="${bloglist }" var="blog">
									<tr >
										<td>${blog.title }</td>
										<td>${blog.content }</td>
										<td>${blog.pictureurl }</td>
										<td>${blog.userid }</td>
										<td>${blog.createtime }</td>
										<td>${blog.replytimes }</td>
										<td><a class="edit" edit-id="${blog.blogid }" href="javascript:;">Edit</a></td>
										<td><a class="delete" del-id="${blog.blogid }" href="javascript:;">Delete</a></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>
	...
	<script src="assets/scripts/manage_blog.js"></script>    
	<script>
