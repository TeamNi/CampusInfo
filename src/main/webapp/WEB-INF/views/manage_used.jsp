...
<body class="page-header-fixed page-boxed page-full-width">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Used Management <small>Management Campus Used</small>
					</h3>
					<em>If you want to comment on used management, please click : </em> <a href="manage_comment_used">here</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-edit"></i>Editable Used Table</div>
							<div class="tools">
							...
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<c:forEach items="${usedlist }" var="used">
									<tr >
										...
										<td>${used.price }</td>
										<td>${used.contact }</td>
										<td>${used.pictureurl }</td>
										<td>${used.userid }</td>
										<td>${used.createtime }</td>
										<td>${used.attentiontimes }</td>
										<td><a edit-id="${used.usedid}" class="edit" href="javascript:;">Edit</a></td>
										<td><a del-id="${used.usedid}" class="delete" href="javascript:;">Delete</a></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>
	...
	<script src="assets/scripts/manage_used.js"></script>    
	<script>
