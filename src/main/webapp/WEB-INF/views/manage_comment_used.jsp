...
<body class="page-header-fixed page-boxed page-full-width">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Used Comment Management <small>Management Campus Used Comment</small>
					</h3>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-edit"></i>Editable Used Comment Table</div>
							<div class="tools">
	...
	<script src="assets/scripts/manage_comment_used.js"></script>    
	<script>
